...
const Navbar = () => {
    ...
    useEffect(() => {
        console.log(searchBox); // This will log the updated state
    }, [searchBox]);
            ...
            <nav className="navbar">
...

                {
                    ...
                    <>
                        <Link to="/dashboard/notification">
                            <button className="w-12 h-12 rounded-full bg-grey relative hover:bg-black/10">
                                <i className="f- fi-rr-bell text-2xl block mt-1"></i>
                            </button>
                        </Link>
                    ...
                    <>
                        ...
                        <Link className="btn-dark py-2 hidden md:block" to="/sign-up">
                            Sign Up
                        </Link>
                    </>
                }
